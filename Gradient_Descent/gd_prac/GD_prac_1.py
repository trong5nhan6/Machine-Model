...
# draw data
fig1 = plt.figure("GD for Linear Regressiion")
ax = plt.axes(xlim=(-10,60), ylim=(-1,20))
plt.plot(A,b,'ro')

# line create by linear regression formular
lr = linear_model.LinearRegression()
lr.fit(A,b)
x0_gd = np.linspace(1,46,2)
y0_sklearn = x0_gd*lr.coef_[0][0] + lr.intercept_[0]
...
# random inititle line
x_init = np.array([[1.],[2.]])
y0_init = x_init[1][0]*x0_gd + x_init[0][0]
